// 1. NOVELAS DESDE EL CÓDIGO (EDITA ESTE ARRAY PARA AGREGAR NOVELAS)
const novelasData = [
    // Puedes agregar más novelas aquí
    {
        ...
        description: "Un hacker de alto nivel fue elegido por el Señor Dios para renacer en innumerables mundos, siempre como un villano prescindible.Sin libre albedrío, cada mundo se convirtió en un callejón sin salida. Cada una de sus vidas terminó trágicamente.Finalmente, después de luchar por el control del sistema de villanos, este hacker experto decidió vengarse. Incluso si sus huesos estuvieran podridos, elegiría ocupar las alturas de la moralidad, aunque solo fuera en la superficie.Así, cambiaría su destino como una escoria ab*sada.",
    ...
    },
    {
        ...
        author: "啄米",
        description: "Tang Xi es un pequeño gatito, un regordete y adorable británico de pelo corto dorado. Dado que a los espíritus no se les permitía manifestarse después de la fundación de la nación, trabajó duro para disfrazarse de cachorro, descargándose de los humanos todos los días. Hasta que un día, fue atrapado por un sistema y enviado a innumerables mundos para completar tareas. Sistema: ¿Cuál es nuestro lema? Tang Xi: ¡Pescado seco! ¡Pescado seco! ¡Pescado seco! El sistema odia el hierro por no convertirse en acero: ¡está salvando al villano!\n\n…..\n\nTang Xi, agarrando un pescado seco, tropezó accidentalmente con el villano en medio de cometer un crimen. Sobresaltado, inmediatamente volvió a su forma de gatito.\n\nLa expresión del villano era ilegible mientras recogía al pequeño gatito esponjoso del suelo: \"¿Hmm?\"\n\nTang Xi: ¡Sistema, ayuda! ¡Estoy a punto de ser comido! QwQ\n\nSistema: Despedida. 😊\n\nEl villano pellizcó suavemente las suaves patas del gatito, levantando una ceja con visible interés.\n\nTang Xi: ... Maullar.\n\n(Haciéndose el lindo a survive.jpg)\n\nUn seme posesivo y ligeramente desquiciado × Un gatito uke ingenuo al que se puede atraer con comida\n\nPD: El uke es pegajoso y mimado alrededor del seme, pero tiene un aura de rompecorazones para los demás (¿porque a quién no le gustan los gatos?). Es un gatito inocente.\n\nEl seme solo ha tenido el uke de principio a fin, física y emocionalmente.",
        link: "",
        status: "Completo",
        chapters: 100,
        rating: 7,
    ...
    },
    {
        ...
        author: "许开,Xu Kai",
        description: "El bebé dragón de la familia del Señor Dios fue despedido y reempleado, y alcanzó la cima de su vida con un guión de carne de cañón en la mano.\n\n——\n\n(1) Estudiantes extranjeros que fueron acusados falsamente de traición → regresaron a la patria para usar la tecnología para convertirnos en los más fuertes del mundo\n\n(2) Personas con habilidades proféticas que fueron explotadas hasta la muerte → Coopere con el país para responder a los desastres con anticipación, y China se convertirá en una tierra pura global después del apocalipsis\n\n(3) El alma de un joven rico se intercambia por un niño pobre → Abandonado por una familia adinerada, el verdadero joven maestro usó sus habilidades para iniciar un negocio más grande y sus padres biológicos se arrepintieron demasiado tarde\n\n. (4) El Omega amante del dinero que quería casarse con una familia adinerada → El chico débil y lindo expuso su identidad Alfa en público y destruyó a un súper Zerg de un solo golpe\n\n(5) Un chico nuevo en la industria del entretenimiento que dice palabras salvajes y está rodeado de fanáticos negros → Como monje de cinco mil años, soy el dios del ajedrez antiguo, la pintura, la poesía y los inmortales. No estoy loco si digo palabras tan arrogantes.\n\n(6) Un joven maestro del continente Xuanwu al que le gustan las joyas y el maquillaje hermoso → El círculo mágico grabado en mi gema puede derribarte la cabeza con solo un lanzamiento.\n\n(7) El general decaído con las piernas incapacitadas → Estudió farmacia y resucitó, y la gloria del héroe que se convirtió en el salvador se volvió cada vez más deslumbrante...",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Cambia la función loadNovelsFromLocalStorage para que también muestre las novelas agregadas en esta sesión
    const loadNovelsFromLocalStorage = () => {
        catalogList.innerHTML = ""; // Limpiar el catálogo antes de mostrar
        const novels = JSON.parse(localStorage.getItem("novels")) || [];
        // Mostrar novelas de localStorage
        novels.forEach((novel) => addNovelToCatalog(novel));
        // Mostrar novelas de novelasData que NO estén ya en localStorage (por título)
    ...
    const addNovelToCatalog = (novel) => {
        ...
        li.innerHTML = `
            <div class="card">
                ...
                <div class="card-back">
                    ...
                    <p>${novel.chapters} capítulos</p>
                    <p>Calificación: ${novel.rating}/10</p>
                    <p>${novel.audience === "adult" ? "🔞 Para adultos" : "Apto para todo público"}</p>
        ...
        catalogList.prepend(li); // Agregar la novela al inicio del catálogo
    };
            ...
            li.innerHTML = `
                <div class="card">
                    ...
                    <div class="card-back">
                        ...
                        <p>${novel.chapters} capítulos</p>
                        <p>Calificación: ${novel.rating}/10</p>
                        <p>${novel.adult ? "🔞 Para adultos" : "Apto para todo público"}</p>
                        <a href="${novel.link}" target="_blank" class="cta-button">Leer Novela</a>
                    </div>
                </div>
            `;
    ...
    const createNovelObject = (imageSrc, pdfSrc) => ({
        ...
        pdf: pdfSrc,
        isFavorite: false,
        audience: document.getElementById("audience").value // Nuevo campo para el público
    });
    ...
    const saveAndDisplayNovel = (novel) => {
        ...
        saveNovelsToLocalStorage(novels);
        loadNovelsFromLocalStorage(); // <-- Esto asegura que se muestre en el catálogo
        addNovelForm.reset();
        ...
        reader.onload = (e) => {
            try {
                ...
                if (Array.isArray(novels)) {
                    ...
                    catalogList.innerHTML = ""; // Limpiar el catálogo
    ...
    // Sobrescribe localStorage solo si está vacío (primera vez)
    ...
    // Si el catálogo está vacío, cargar novelasData y guardarlas
    ...
    // Función para filtrar novelas por palabras completas
    ...
    // Función para verificar coincidencias de palabras completas
    function matchWords(text, searchValue) {
        ...
        const searchWords = searchValue.split(/\s+/); // Dividir el valor de búsqueda en palabras
        return searchWords.every(word => words.some(w => w.startsWith(word))); // Verificar si las palabras comienzan con el valor de búsqueda
    }

    // Agregar novela a los resultados de búsqueda
    ...
    // Cuenta maestra (puedes cambiar el usuario y contraseña aquí)
    ...
    loginBtn.addEventListener("click", () => {
        ...
        if (username === MASTER_USER && password === MASTER_PASS) {
            ...
            alert("Sesión iniciada como cuenta maestra.");
            userModal.style.display = "none";
            updateUIForUser();
            return;
        }
    ...
    // Mostrar/ocultar sección de agregar novela solo para cuenta maestra
    ...
    // Al cargar la página, actualizar UI según usuario
    updateUIForUser();
